...
if (isset($_SESSION['Logged_in']) && $_SESSION['user_type'] == 'seller') {
    ...
    $allproduct = $prod->allProducts($sellerId);
    $cat = new Categories();
                ...
                <table class="table">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="text-dark">Stock</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <textarea class="text-dark form-control" name="proDesc" type="text"
                            ...
                            <td>
                                <h5 class="text-dark"><?= $product['pName'] ?></h5>
                            </td>
